...
def draw_boxes(img, bboxes, color=(0, 0, 255), thick=6):
    ...
    imcopy = np.copy(img)
    # Iterate through the bounding boxes & Draw a rectangle given bbox coordinates
    for bbox in bboxes: cv2.rectangle(imcopy, bbox[0], bbox[1], color, thick)
...
def draw_labeled_bboxes(img, labels, maxV=255):
    ...
    for car_number in range(1, labels[1]+1):
        ...
        cv2.rectangle(img, bbox[0], bbox[1], (0,0,maxV), 6)
    # Return the image
    return img
